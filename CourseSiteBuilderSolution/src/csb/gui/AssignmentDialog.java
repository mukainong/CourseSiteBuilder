...
public class AssignmentDialog  extends Stage {
    ...
    // AND THIS HAS DATE INFO TO HELP WITH VERIFICATION
    Course course;
     ...
     */
    public AssignmentDialog(Stage initStage, Course initCourse, MessageDialog initMessageDialog) {
        // KEEP THIS FOR LATER
        messageDialog = initMessageDialog;
        
        // WE NEED THIS TO VERIFY DATES
        course = initCourse;
